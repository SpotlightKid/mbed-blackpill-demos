...
#define USE_PLL_HSE_EXTC     0x8  // Use external clock
#define USE_PLL_HSE_XTAL     0x4  // Use external xtal (Y2 on board)
...
#if (DEVICE_USBDEVICE)
        RCC_OscInitStruct.PLL.PLLN            = 192;           // VCO output clock = 384 MHz (1 MHz * 192)
#else /* DEVICE_USBDEVICE */
        RCC_OscInitStruct.PLL.PLLN            = 200;           // VCO output clock = 400 MHz (1 MHz * 200)
